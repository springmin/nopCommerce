...
public partial interface ICustomWishlistService
{
    ...
    Task<IList<CustomWishlist>> GetAllCustomWishlistsAsync(long customerId);
    ...
    Task RemoveCustomWishlistAsync(long itemId);
    ...
    Task<CustomWishlist> GetCustomWishlistByIdAsync(long itemId);
}
