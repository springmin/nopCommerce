...
public partial class PrivateMessageBuilder : NopEntityBuilder<PrivateMessage>
{
    ...
    public override void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(PrivateMessage.FromCustomerId)).AsInt64().ForeignKey<Customer>().OnDelete(Rule.None)
            .WithColumn(nameof(PrivateMessage.ToCustomerId)).AsInt64().ForeignKey<Customer>().OnDelete(Rule.None);
    }
